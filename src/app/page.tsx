    ...
    <AppLayout>
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-black">Lista de Compras</CardTitle>
              <ShoppingBag className="h-4 w-4 text-orange-600" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-orange-600">{data.pendingShoppingItems}</div>
              <p className="text-xs text-black font-medium">
                Items por reponer
                {data.pendingShoppingItems > 0 && <span className="block text-gray-500 mt-1 cursor-pointer hover:underline">Ir a comprar &rarr;</span>}
              </p>
            </CardContent>
          </Card>
